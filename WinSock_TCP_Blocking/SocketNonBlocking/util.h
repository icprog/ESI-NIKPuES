...
void add(Buffer buffer, char *data, int pushIdx, int popIdx, int count);            // adding data to the buffer
void remove(Buffer buffer, char *data, int pushIdx, int popIdx, int count);         // removing data from the buffer
